...
@Algorithm(name="AFBB3ORIGConstrained", useIdleDetector=false)
public class AFBB3ORIGConstrainedAgent extends SimpleAgent {
    ...
    public void handleFBESTIMATE(TimeStamp hisTimeStamp, int estimate, HashMap<Integer, HashMap<Integer, Integer>> pa, int aj) {
        if (hisTimeStamp.compare(timeStamp, this) >= 0) {
            timeStamp.copyFrom(hisTimeStamp);
        } else {
            return;
