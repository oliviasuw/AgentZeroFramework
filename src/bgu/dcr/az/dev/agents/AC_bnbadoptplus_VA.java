...
@Algorithm(name="AC_bnbadoptplus_VA", useIdleDetector=true)   // Corresponds to the algorithm name in the .xml file
public class AC_bnbadoptplus_VA extends SimpleAgent {
