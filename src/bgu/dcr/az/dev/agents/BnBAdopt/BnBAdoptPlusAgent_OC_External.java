/**
 * BnBAdoptPlusAgent_OC_External.java
   Created by Su Wen
   Date: Mar 31, 2015
   Time: 9:02:40 PM 
 */
 ...
 */
@Algorithm(name="BnBAdoptPlusAgent_OC_External", useIdleDetector=true)   // Corresponds to the algorithm name in the .xml file
public class BnBAdoptPlusAgent_OC_External extends SimpleAgent {
